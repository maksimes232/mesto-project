...
export {formAddNewCardTitle, formAddNewCardImg, cardTemplate, popupEditProfileFormName, profileAddButton, profileEditProfileBtn, cardsStorage, popupfullSizeImg, popupFullSizeTitle, profileName, profileDesciption}